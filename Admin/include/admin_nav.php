        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./reg_candidate.php">Candidates</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./reg_voter.php">Voters</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../users/view_results.php">Results</a>
                    </li>
                    <li class="nav-item">
